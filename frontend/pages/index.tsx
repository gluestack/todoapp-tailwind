        ...
        {user ?
          <div className='w-100 bg-gray-50 text-gray-700'>
            ...
            <span className='flex justify-evenly mt-6'>
              <Link href={"/signin"}><Button className="hover:bg-gray-200">Sign In</Button></Link>
              <Link href={"/signup"}><Button className="bg-gray-200 hover:bg-transparent">Sign Up</Button></Link>
            </span>
